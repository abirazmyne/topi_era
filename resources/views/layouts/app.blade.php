    ...
    <div class="navbar-custom">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex align-items-start">
                                        <img class="d-flex me-2 rounded-circle" src="/admin/assets/images/users/user-2.jpg" alt="Generic placeholder image" height="32">
                                        <div class="w-100">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex align-items-start">
                                        <img class="d-flex me-2 rounded-circle" src="/admin/assets/images/users/user-5.jpg" alt="Generic placeholder image" height="32">
                                        <div class="w-100">
        ...
        <div class="logo-box">
            <a href="index.html" class="logo logo-light text-center">
                ...
                <span class="logo-lg">
                                <img src="/admin/assets/images/logo-light.png" alt="" height="16">
                            </span>
            </a>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
            ...
            <li>
                <h4 class="page-title-main page-title">@yield('page-title', 'Dashboard')</h4>
    ...
    <div class="left-side-menu">
        ...
        <div class="h-100" data-simplebar>
            ...
            <div class="user-box text-center">
                ...
                <div class="dropdown">
                    <a href="{{route('category.point')}}" class="user-name dropdown-toggle h5 mt-2 mb-1 d-block" data-bs-toggle="dropdown"  aria-expanded="false">Nowak Helme</a>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="email">
                            <ul class="nav-second-level">
                                <li>
                                    <a href="{{route('category.point')}}">Category</a>
                                </li>
                                <li>
                            ...
                            <ul class="nav-second-level">
                                <li>
                                    <a href="#sidebarMultilevel2" data-bs-toggle="collapse">
                                        Category <span class="menu-arrow"></span>
                                    </a>
