...
<head>
    ...
    <meta name="description" content="A brief description of your page that includes important keywords. Keep it under 160 characters.">
    ...
    <!-- Font Icons css -->
    <link rel="stylesheet" href="/assets/website/css/font-icons.css">

    <!-- Plugins css -->
    <link rel="stylesheet" href="/assets/website/css/plugins.css">
...
<div class="body-wrapper">
   ...
   @include('website.main.header.header')
    @yield('body')

   @include('website.main.footer.footer')
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="modal-product-img">
                                            <img src="/assets/website/img/product/4.png" alt="#">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                        ...
                        <div class="ltn__quick-view-modal-inner">
                            <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="/assets/website/img/product/1.png" alt="#">
                                        </div>
                                        <div class="modal-product-info">
                                        ...
                                        <div class="additional-info d-none">
                                            ...
                                            <div class="payment-method">
                                                <img src="/assets/website/img/icons/payment.png" alt="#">
                                            </div>
                                        </div>
                                    </div>
                                </div>
